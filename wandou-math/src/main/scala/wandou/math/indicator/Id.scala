...
import wandou.math.timeseries.TSer
...
object Id {
  ...
  def main(args: Array[String]) {
    ...
    val id5 = Id(classOf[Indicator], keya, wandou.math.timeseries.TFreq.ONE_MIN)
    val id6 = Id(classOf[Indicator], keyb, wandou.math.timeseries.TFreq.withName("1m").get)
    println(id5 == id6)
  }
}
